...
public class restFrame extends JFrame {
    public restFrame(ArrayList<Player> pLi) {
        ...
        *********/
        ...
        FOUNTAIN   
        *******/
        JLabel fountain = new JLabel(new ImageIcon("./image-rooms/room1.jpg"));
        fountain.setSize(780, 450);
        fountain.setBounds(1080, 300, 780, 450);
        frame.add(fountain);
