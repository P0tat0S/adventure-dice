...
public class treasureFrame extends JFrame {
    public treasureFrame(ArrayList<Player> pLi) {
        ...
        *********/
        ...
        Treasure   
        *******/
        JLabel treasure = new JLabel(new ImageIcon("./image-rooms/room4.jpg"));
        treasure.setSize(780, 450);
        treasure.setBounds(1080, 300, 780, 450);
        frame.add(treasure);
